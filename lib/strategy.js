...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'http://github.forbes.com/login/oauth/authorize';
  options.tokenURL = options.tokenURL || 'http://github.forbes.com/login/oauth/access_token';
  ...
  this.name = 'github';
  this._userProfileURL = options.userProfileURL || 'http://github.forbes.com/api/v3/user';
